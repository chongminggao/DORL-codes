...
class CQLPolicy_withEmbedding(CQLPolicy):
    ...
    def __init__(
        ...
        super().__init__(
            actor, actor_optim, critic1, critic1_optim, critic2, critic2_optim, cql_alpha_lr, cql_weight, tau, gamma,
            alpha, temperature, with_lagrange, lagrange_threshold, min_action, max_action, num_repeat_actions,
            alpha_min, alpha_max, clip_grad,
            device, **kwargs
        )
