...
class BCQPolicy_withEmbedding(BCQPolicy):
    ...
    def __init__(
        ...
        super().__init__(actor, actor_optim, critic1, critic1_optim, critic2, critic2_optim, vae, vae_optim, device,
                         gamma, tau, lmbda, forward_sampled_times, num_sampled_action, **kwargs)
