...
from environments.YahooR3.env.Yahoo import YahooEnv, negative_sampling, compute_normed_reward_for_all, \
    construct_complete_val_x
...
def load_static_validate_data_yahoo(user_features, item_features, reward_features, entity_dim, feature_dim,
                                    DATAPATH):
    df_val, df_user, df_item, list_feat = YahooEnv.get_df_yahoo("ydata-ymusic-rating-study-v1_0-test.txt")
