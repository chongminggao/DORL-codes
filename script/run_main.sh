...
#python run_linUCB.py         --env KuaiEnv-v0  --seed 0 --cuda 2 --loss "pointneg" --message "UCB" &
#python run_epsilongreedy.py  --env KuaiEnv-v0  --seed 0 --cuda 3 --loss "pointneg" --message "epsilon-greedy" &
...
python run_Policy_IPS.py  --env KuaiEnv-v0  --seed 0 --cuda 7   --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --lambda_variance 0    --lambda_entropy 0    --window_size 3 --read_message "pointneg"  --message "IPS" &
...
#python run_linUCB.py         --env KuaiRand-v0  --seed 0 --cuda 2 --loss "pointneg" --message "UCB" &
#python run_epsilongreedy.py  --env KuaiRand-v0  --seed 0 --cuda 3 --loss "pointneg" --message "epsilon-greedy" &
...
python run_Policy_IPS.py  --env KuaiRand-v0  --seed 0 --cuda 7   --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --lambda_variance 0    --lambda_entropy 0     --window_size 3 --read_message "pointneg"  --message "IPS" &
